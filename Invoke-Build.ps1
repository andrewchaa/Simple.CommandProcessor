<#
.SYNOPSIS
Modular build automation for .NET leveraging Invoke-Build

.DESCRIPTION
This command invokes a set of PowerShell build automation scripts.

.LINK
Invoke-Build project https://github.com/nightroman/Invoke-Build
...
Default to the Invoke-Build script directory.
...
param(
    ...
    # BuildAutomation specific parameters
    [switch]$Tree,
...
# Include BuildAutomation script
. (Join-Path $BuildFullPath "scripts\MarketInvoice.BuildAutomation.ps1")
